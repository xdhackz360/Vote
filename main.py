...
"""
    await message.reply_text(welcome_text, reply_markup=reply_markup, parse_mode=ParseMode.MARKDOWN, disable_web_page_preview=True)
...
"""
        await message.reply_text(success_message, parse_mode=ParseMode.MARKDOWN, disable_web_page_preview=True)
